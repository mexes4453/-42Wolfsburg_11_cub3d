...
#    Updated: 2023/03/23 21:01:47 by fsemke           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS =	src/cub3d.c \
		...
		src/ft_draw_line.c \
		src/ft_onKeyPress_W.c \
		src/ft_onKeyPress_S.c \
		src/ft_onKeyPress_A.c \
		src/ft_onKeyPress_D.c \
		src/ft_player_move.c \
		src/ft_key.c \
		src/ft_ray_get_dist_horz.c \
		#src/ft_ray_get_dist_vert.c
