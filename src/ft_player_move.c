...
/*   Updated: 2023/03/28 19:11:19 by fsemke           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int ft_loop_player(t_app *app)
{
	...
	mlx_put_image_to_window(app->com, app->win, app->black_backgroud->img_ref_ptr, 0, 0);
	ft_app_display_map(app, app->map, "1", app->img);
